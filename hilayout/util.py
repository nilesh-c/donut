...
class LayoutTransformerDataset(Dataset):
    ...
    def _generate_token_sequences(self):
        ...
        cache_path = os.path.join(self.dataset_name_or_path, f"cache_gt_tokens_{self.split}.pkl")
        if self.use_cache and os.path.exists(cache_path):
            ...
            for sample in tqdm(self.dataset, desc="Converting json parses to token sequences for split {}".format(self.split), dynamic_ncols=True, position=0, unit="sample"):
